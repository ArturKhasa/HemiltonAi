...
# Изделие, для которого нужна палитра: у худи своя.
#
# «Толстовка» сюда не входит. В скриптах ОП это слово стоит в ветке свитшота
# («Стоимость толстовки — 5 990 ₽»), а условие самого скрипта палитры худи
# сказано прямо: «Только если клиент САМ сказал «худи»». Пока «толстовк» ловилось
# здесь, клиенту, спросившему «А из какого материала толстовка?», к вопросу про
# цвет свитшота уходила вешалка с ХУДИ (диалог 75800, 20.08 23:16).
_HOODIE_RE = re.compile(r"худи|капюшон", re.I)
